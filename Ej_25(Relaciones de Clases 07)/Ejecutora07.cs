...
namespace Ej_25_Relaciones_de_Clases_07_
{
    class Ejecutora07
    {
        ...
        7) En la empresa del ejercicio anterior se incorporó a un nuevo tipo de empleado, los profesionales. Los mismos cobran 
            un adicional del 10% del básico. Modificar el ejercicio anterior según este nuevo requerimiento
